...
import { Input, Label, FormGroup, Button, FormFeedback, Col } from "reactstrap";
  ...
  renderButton(label) {
    return (
      <FormGroup align="center">
        <Button color="success" outline block disabled={this.validate()}>
          {" "}
    ...
    return (
      <FormGroup>
        <Col sm={12} align="center">
          <Rate value={data[name]} onChange={this.handleRateChange} />
        </Col>
        <FormFeedback>{errors[name]}</FormFeedback>
      </FormGroup>
    );
