...
class ChatShell extends React.Component {
    ...
    componentDidMount() {
        ...
        if (this.props.currentUser) {
            this.setState({
                sender: this.props.currentUser ? JSON.parse(this.props.currentUser).id : null
            })
            this.props.loadConversations(JSON.parse(this.props.currentUser).id)
...
export default connect(mapStateToProps, {
    loadConversations, conversationChanged, messagesRequested, sendMessage, wsConnect
})(ChatShell);
