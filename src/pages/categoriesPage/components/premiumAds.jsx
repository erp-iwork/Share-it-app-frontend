    ...
    return (
      <Carousel autoPlay infiniteLoop showThumbs={true}>
        <div className="container1">
          <img alt="" className="resize_fit_center" src={Logo2} />
          <p className="legend">Car</p>
        </div>
        <div className="container1">
          <img alt="" className="resize_fit_center" src={Logo} />
          <p className="legend">App</p>
        </div>
        <div className="container1">
          <img alt="" className="resize_fit_center" src={Logo3} />
          <p className="legend">Someone For Hire</p>
        </div>
        <div className="container1">
          <img alt="" className="resize_fit_center" src={Logo4} />
